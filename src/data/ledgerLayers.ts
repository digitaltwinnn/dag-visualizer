...
export interface LedgerLayerCopy {
  ...
  name: string;
  desc: string;
  /** STACK LEVEL, counting up from the base settlement (Global snapshots = 1). The split
...
export const LEDGER_LAYERS: LedgerLayerCopy[] = [
  ...
  { id: "gl0", level: "1", name: "Global snapshots", desc: "The base settlement: where every metagraph snapshot anchors." },
];
