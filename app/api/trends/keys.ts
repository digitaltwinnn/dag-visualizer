...
// which day-tile immutable caching protects). The finite eras remain as history's floors:
// 5m fields exist from 2026-09-06 (the recompute that healed the pre-prod holes), hourly
// from ~2026-05-13 (120 days before the flip) — TIER_SINCE in src/data/trendWindow.ts is
// the client's map of those floors.
