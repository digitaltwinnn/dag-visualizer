...
// Node-status palette + the real pill for /design. The bucket colours are LITERALS in
// src/data/nodeStatus.ts (a separate lane from the CSS tokens — read BUCKET_COLOR here so the
// swatches can't drift); the pills below are the REAL StatusMark the cards render. Client
// component because it lives in a "use client" module.
...
export default function StatusDemo() {
  return (
    <div className="flex flex-col gap-4 max-w-2xl">
      ...
      {/* The real pill chrome — one per bucket (StatusMark). */}
      <div className="ig-panel p-4 flex flex-wrap items-center gap-2">
